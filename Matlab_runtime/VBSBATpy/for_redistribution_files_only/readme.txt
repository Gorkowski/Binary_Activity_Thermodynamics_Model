VBSBATpy MATLAB Python Package
...
2. Installing the VBSBATpy Package

A. Change to the directory that contains the file setup.py and the subdirectory VBSBATpy. 
...
3. Using the VBSBATpy Package

The VBSBATpy package is on your Python path. To import it into a Python script or 
session, execute:

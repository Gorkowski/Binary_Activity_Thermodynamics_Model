...
% %% test extremes
% clear
% guess_Ej=  [0.0269482661652176;0.356015485468693;0.161961397410055;0.999984266018315;0.344628565184500;0.992535073686157;0.998023977276474;0.999984160920101;0.124264815131966;0.999492046478144];;
...
% guess_CoaAlpha_ugPm3=guess_Ej(1,1);
% guess_CoaBeta_ugPm3=guess_Ej(2,1);
% guess_q_alpha_water=guess_Ej(3,1);
...
Coa_j_alpha=Coa_j.*q_alpha; % orgnaic mass
Caq_alpha=sum(Coa_j_alpha.*mass_fraction_water_alpha./mass_fraction_water_alpha_denominator); % water mass based on organic mass and mass fraction of water from BAT model
Coaaq_alpha=sum(Coa_j_alpha)+Caq_alpha; % water plus organic mass

% beta phase calculation
Coa_j_beta=Coa_j.*q_beta; % orgnaic mass
Caq_beta=sum(Coa_j_beta.*mass_fraction_water_beta./mass_fraction_water_beta_denominator); % water mass based on organic mass and mass fraction of water from BAT model
Coaaq_beta=sum(Coa_j_beta)+Caq_beta; % water plus organic mass

Coaaq_via_Ej_guess=Coaaq_beta+Coaaq_alpha; % total organic plus water mass 
...
% error for convergence of VBS, based on squared error of Ej and organic
% mass

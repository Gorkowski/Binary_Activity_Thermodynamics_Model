...
%% makes a squeezed logistic function to transfer for q_alpha ~0 to q_alpha ~1, described in VBSBAT_options.q_alpha
...
% apply mask for complete miscibility, turns miscible organics to

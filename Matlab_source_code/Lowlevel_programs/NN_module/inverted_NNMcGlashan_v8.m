function [mole_frac_org_alpha, mole_frac_org_beta] = inverted_NNMcGlashan_v8(O2C, H2C, Mratio, a_w, mode)
...
for i=1:length(Mratio)
    ...
    if O2C(i,1)<O2C_single_phase_cross_point % biphasic
        ...
        [RH_cross_point] = biphasic_to_single_phase_RH_master_v3(O2C(i,1), H2C(i,1), Mratio(i,1), mode);

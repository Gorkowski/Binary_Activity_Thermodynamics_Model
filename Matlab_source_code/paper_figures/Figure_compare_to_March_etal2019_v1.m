...
[VBSBAT_mix1_C_OA_PM, VBSBAT_mix1_Caq_PM, VBSBAT_mix1_kappaHGF, details_mix1]=VBS_BAT_simulation_v2(...
    ...
    mixture1_O2C, mixture1_H2C,  mixture1_MolarMass, aw_series, mixture1_functional_group, McGlashan_refinement_mode, VBSBAT_options);
...
[VBSBAT_mix2_C_OA_PM, VBSBAT_mix2_Caq_PM, VBSBAT_mix2_kappaHGF, details_mix2]=VBS_BAT_simulation_v2(...
    Csat_ugPm3, Org_Conc_OM, ...
    mixture2_O2C, mixture2_H2C,  mixture2_MolarMass, aw_series, mixture2_functional_group, McGlashan_refinement_mode, VBSBAT_options);
...
[VBSBAT_mix3_C_OA_PM, VBSBAT_mix3_Caq_PM, VBSBAT_mix3_kappaHGF, details_mix3]=VBS_BAT_simulation_v2(...
    Csat_ugPm3, Org_Conc_OM, ...
    mixture3_O2C, mixture3_H2C,  mixture3_MolarMass, aw_series, mixture3_functional_group, McGlashan_refinement_mode, VBSBAT_options);
...
[VBSBAT_mix4_C_OA_PM, VBSBAT_mix4_Caq_PM, VBSBAT_mix4_kappaHGF, details_mix3]=VBS_BAT_simulation_v2(...
    Csat_ugPm3, Org_Conc_OM, ...
    mixture4_O2C, mixture4_H2C,  mixture4_MolarMass, aw_series, mixture4_functional_group, McGlashan_refinement_mode, VBSBAT_options);
...
[VBSBAT_mix5_C_OA_PM, VBSBAT_mix5_Caq_PM, VBSBAT_mix5_kappaHGF, details_mix3]=VBS_BAT_simulation_v2(...
    Csat_ugPm3, Org_Conc_OM, ...
    mixture5_O2C, mixture5_H2C,  mixture5_MolarMass, aw_series, mixture5_functional_group, McGlashan_refinement_mode, VBSBAT_options);
...
[VBSBAT_mix6_C_OA_PM, VBSBAT_mix6_Caq_PM, VBSBAT_mix6_kappaHGF, details_mix3]=VBS_BAT_simulation_v2(...
    Csat_ugPm3, Org_Conc_OM, ...
    mixture6_O2C, mixture6_H2C,  mixture6_MolarMass, aw_series, mixture6_functional_group, McGlashan_refinement_mode, VBSBAT_options);
...
[VBSBAT_mix7_C_OA_PM, VBSBAT_mix7_Caq_PM, VBSBAT_mix7_kappaHGF, details_mix3]=VBS_BAT_simulation_v2(...
    Csat_ugPm3, Org_Conc_OM, ...
    mixture7_O2C, mixture7_H2C,  mixture7_MolarMass, aw_series, mixture7_functional_group, McGlashan_refinement_mode, VBSBAT_options);
...
plot(MFS_OT(:,1),MFS_VBSBAT(:,1),...
    'MarkerFaceColor',[0.584313750267029 0.388235300779343 0.388235300779343],...
    'MarkerEdgeColor',[0.584313750267029 0.388235300779343 0.388235300779343],...
    'MarkerSize',m_size,...
    'Marker','diamond',...
...
plot(MFS_OT(:,2),MFS_VBSBAT(:,2),...
    'MarkerFaceColor',[0.839215695858002 0.909803926944733 0.850980401039124],...
    'MarkerEdgeColor',[0.584313750267029 0.388235300779343 0.388235300779343],...
    'MarkerSize',m_size,...
    'Marker','diamond',...
...
plot(MFS_OT(:,4),MFS_VBSBAT(:,4),...
    ...
    'MarkerEdgeColor',[0.952941179275513 0.87058824300766 0.733333349227905],...
    'MarkerSize',m_size,...
    'Marker','v',...
...
plot(MFS_OT(:,5),MFS_VBSBAT(:,5),...
    'MarkerFaceColor',[0.105882354080677 0.309803932905197 0.207843139767647],...
    'MarkerEdgeColor',[0.105882354080677 0.309803932905197 0.207843139767647],...
    'MarkerSize',m_size,...
    'Marker','o',...
...
plot(MFS_OT(:,6),MFS_VBSBAT(:,6),...
    'MarkerFaceColor',[0.450980395078659 0.26274511218071 0.26274511218071],...
    'MarkerEdgeColor',[0.450980395078659 0.26274511218071 0.26274511218071],...
    'MarkerSize',m_size,...
    'Marker','diamond',...

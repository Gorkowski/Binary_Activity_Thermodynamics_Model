...
% % set 4
% load('DATA for figure kappaCCN low O2C water.mat', 'Dp_sim_nm', ...
%     'Molar_mass', 'O2C_value', 'Diameter_total', 'SatRatio', 'kappa', 'a_w', 'alternate',...
%     'index_phase_sep_starts', 'index_phase_sep_end','SatCritical','Dp_critical', 'kappa_a_w', 'kappa_SatCritical')
% labelO2C(:,4)=O2C_value;
% Diameter_total_combo(:,4)=Diameter_total;
% SatRatio_combo(:,4)=SatRatio;
% kappa_combo(:,4)=kappa;
% a_w_combo(:,4)=a_w;
% alternate_combo(4)=alternate;
% index_phase_sep_starts_combo(4)=index_phase_sep_starts;
% index_phase_sep_end_combo(4)=index_phase_sep_end;
% SatCritical_combo(4)=SatCritical;
% Dp_critical_combo(4)=Dp_critical;
% kappa_a_w_combo(4)=kappa_a_w;
% kappa_SatCritical_combo(4)=kappa_SatCritical;
% disp(text_settings)

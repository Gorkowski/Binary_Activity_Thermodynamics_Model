...
%% settings
% mode='hydroperoxide'; %    'hydroxyl'='carboxyl', 'hydroperoxideSOA', 'PEG', 'hydroperoxide'
...
% From Kuwata, M., Shao, W., Lebouteiller, R. and Martin, S. T.: Classifying organic materials by oxygen-to-carbon elemental ratio to predict the activation regime of Cloud Condensation Nuclei (CCN), Atmos. Chem. Phys., 13(10), 5309–5324, doi:10.5194/acp-13-5309-2013, 2013.
%Wang, J., Shilling, J. E., Liu, J., Zelenyuk, A., Bell, D. M., Petters, M., Thalman, R., Mei, F., Zaveri, R. A. and Zheng, G.: Cloud droplet activation of secondary organic aerosol is mainly controlled by molecular weight, not water solubility, Atmos. Chem. Phys. Discuss., (July), 1–34, doi:http://dx.doi.org/10.1016/j.physletb.2012.12.029, 2018.
%Cain, K. P. and Pandis, S. N.: A technique for the measurement of organic aerosol hygroscopicity, oxidation level, and volatility distributions, Atmos. Meas. Tech. Discuss., (July), 1–30, doi:10.5194/amt-2017-213, 2017.
% toluene Hildebrandt Ruiz, L., Paciga, A. L., Cerully, K. M., Nenes, A., Donahue, N. M. and Pandis, S. N.: Formation and aging of secondary organic aerosol from toluene: Changes in chemical composition, volatility, and hygroscopicity, Atmos. Chem. Phys., 15(14), 8301–8313, doi:10.5194/acp-15-8301-2015, 2015.

% alpha_pinene_data=[.12, .48; [0.1 0.55];[0.1 0.52];[0.1 0.5];[0.1 0.5];[0.11 0.53]; [0.11 0.57]; [0.1 0.44];...
%     [0.1 0.59]; [0.11, 0.61]; [0.1, .48]; [0.1, .44]; [0.11 .41]; [0.1 .4];...
%     [0.11 0.38]];
% isporene_data=[[0.16, 0.87]; [0.17 0.71]; [0.16 0.72]; [0.15, .72]; [0.16 .69]];
% d3carene_data=[[0.1, 0.53]; [0.1, 0.53]];
% beta_caryophyllene=[[0.07, 0.33]];
...
% c17 Lambe, A. T., Onasch, T. B., Massoli, P., Croasdale, D. R., Wright, J. P., Ahern, A. T., Williams, L. R., Worsnop, D. R., Brune, W. H. and Davidovits, P.: Laboratory studies of the chemical composition and cloud condensation nuclei (CCN) activity of secondary organic aerosol (SOA) and oxidized primary organic aerosol (OPOA), Atmos. Chem. Phys., 11(17), 8913–8928, doi:10.5194/acp-11-8913-2011, 2011.
% c17_PAM=[0.0118343195266272,0.136482939632546;0.0627218934911242,0.162729658792651;0.105325443786982,0.220472440944882;0.113609467455621,0.388451443569554;0.139644970414201,0.624671916010499;0.224852071005917,0.923884514435696];
